...
interface ConsultaBasicaDetalleProps {
  loading: boolean;
  consulta?: {
    tipo: string;
    fecha: string | null;
...
const ConsultaBasicaDetalle: React.FC<ConsultaBasicaDetalleProps> = ({
  loading,
  consulta,
}) => {
  if (loading) {
...
export default ConsultaBasicaDetalle;
