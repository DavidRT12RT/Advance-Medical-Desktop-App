...
const ModalHistorialCambios: React.FC<ModalHistorialCambiosProps> = ({
  ...
  const formatFieldName = (field: string): string => {
    const fieldNames: Record<string, string> = {
      ...
      medico_nombre: "Médico endoscopista - Nombre",
      medico_cedula: "Médico endoscopista - Cédula",
      medico_especialidad: "Médico endoscopista - Especialidad",
      tratante_nombre: "Médico tratante - Nombre",
      tratante_cedula: "Médico tratante - Cédula",
      tratante_especialidad: "Médico tratante - Especialidad",
